...
def processdata():
    ...
    while(True):
        ...
        SOIL_SLEEP_INTERVAL_SECONDS = os.environ['SOIL_SLEEP_INTERVAL_SECONDS']
        ...
        print(f"Sleeping for {SOIL_SLEEP_INTERVAL_SECONDS} seconds")
        time.sleep(int(SOIL_SLEEP_INTERVAL_SECONDS))
...
def main():
    ...
    try:  
        ...
        os.environ['SOIL_SLEEP_INTERVAL_SECONDS']
    except KeyError: 
        print("Not all environment variables have been set.")
        print("Please set INFLUX_TOKEN, INFLUX_ORG, INFLUX_BUCKET, INFLUX_URL, INFLUX_BATCH_SIZE, SOIL_DATA_LOCATION,SOIL_SLEEP_INTERVAL_SECONDS")
        sys.exit(1)
